            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('vendor.profile.update',$user->id)}}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" placeholder="Enter price" name="email" value="{{$user->email}}">
                                        </div>
                                    </div> -->
                                </div>
                                <div class="row">
