...
@if(session('success'))
    ...
    <div class="has-bg-img">
         <div class="bg-img bg-cover">
          <h1 class="text-center mx-auto text-light text-bold h1-text-size" style="padding-top:40vh;">Gift Cards</h1>
         </div>
    </div>
                            ...
                            <div class="row">
                                @foreach($products as $product)
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <img src="{{ asset('dist/img/'.$product->image_name) }}" class="card-image" width="100%" height="50%" alt="image" />
                                        <hr>
